...
📱 Flutter Developer  
🌐 Web Developer  
🤖 Embedded Systems & Microcontrollers Programmer  
🧠 AI Student  
...
<a href="https://github.com/MohamedAyman">
...
![VSCode](https://img.shields.io/badge/Visual_Studio_Code-0078D4?style=flat&logo=visual-studio-code)
![Figma](https://img.shields.io/badge/Figma-F24E1E?style=flat&logo=figma)

```dart
// tools_I_use organized for Mohamed Ayman

class About extends Me { 
  const myTools = {  
    "ProgrammingLanguages" : { "Dart", "C++", "C", "Python", "JavaScript" },
    "EmbeddedSystems" : { "MicroC", "PIC", "Sensors", "Circuits" },
